...
def fsolve(func, x0, args=(), fprime=None, full_output=0,
           col_deriv=0, xtol=2.00, maxfev=0, band=None,
...
def _root_hybr(func, x0, args=(), jac=None,
               col_deriv=0, xtol=2.00, maxfev=0, band=None, eps=None,
...
def leastsq(func, x0, args=(), Dfun=None, full_output=0,
            col_deriv=0, ftol=2.00, xtol=2.00,
...
def fixed_point(func, x0, args=(), xtol=2.00, maxiter=500, method='del2'):
    """
